    ...
    >
      <div className="w-container mx-auto flex justify-between items-center">
        ...
        <ul className="sm:flex hidden w-full lg:w-auto justify-end lg:justify-center items-center flex-1 font-medium text-[13px]">
          {navLinks.map((nav) => (
            <li key={nav.id} className="mr-8 last:mr-0 hover:opacity-50">
        ...
        <div className="sm:hidden flex justify-end items-center">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "fixed"
            } top-0 bottom-0 left-0 right-0 bg-overlay`}
          />
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } absolute top-[250px] left-0 right-0 bottom-0 flex-col justify-center items-center z-20 sidebar`}
          >
