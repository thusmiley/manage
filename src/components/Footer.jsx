...
const Footer = () => {
  ...
  const errorMessage = () => {
    return (
      <div className="text-primary" style={{ display: error ? "" : "none" }}>
  ...
  return (
    <footer className="bg-almostBlack text-white ">
      <div className="w-container mx-auto pt-40 pb-7 lg:py-16 relative lg:flex lg:justify-between lg:gap-28 lg:items-center">
        <div className="flex flex-col-reverse lg:flex-row lg:justify-between lg:w-[65%]">
          <div className="flexCenter  flex-col-reverse lg:flex-col lg:items-stretch lg:h-full lg:w-[45%]">
        ...
        <div className="mt-12 lg:mt-0 text-center lg:w-[35%] lg:flex-col">
          ...
          <p className="text-white/50 text-[13px] tracking-[-0.2px] lg:text-right">
